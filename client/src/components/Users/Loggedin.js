		...
		<div style={{ display: "flex", flexDirection: "column" }}>
			...
			>
				...
				>
					...
					<Typography sx={{ fontSize: "1.5rem", userSelect: "none" }}>
						NeighbourNet.
					</Typography>
				</Box>
				<Box
			...
			>
				<Drawer
					...
					sx={{
						width: drawerOpen ? "15rem" : "4.5rem",
						position: "fixed",
						top: "4rem",
						zIndex: "100",
						height: "calc(100vh - 4rem)",
						borderTop: "2px solid #1E201E",
				...
				>
					...
					>
						...
						>
							<ListItemButton
								className="listButton dashBoard"
								onClick={() => {
									setNowOpen(1);
								}}
								sx={{ maxHeight: "5rem" }}
						...
						>
							<ListItemButton
								className="listButton helpRequest"
								onClick={() => {
									setNowOpen(2);
								}}
								sx={{ maxHeight: "5rem" }}
						...
						>
							<ListItemButton
								className="listButton resourceRequest"
								onClick={() => {
									setNowOpen(3);
								}}
								sx={{ maxHeight: "5rem" }}
					...
					<div>
						<ListItemButton
							className="listButton darkHumour"
