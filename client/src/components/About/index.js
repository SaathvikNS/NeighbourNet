...
const About = () => {
  return (
    <div>
        <section id='title'>
            <Header/>
            <img src='/assets/aboutbg.jpg' style={{position: 'absolute', width: '100vw', objectFit: 'cover', zIndex: '-10'}} alt='About Background'></img>
        ...
        <section id='welcome' className='a'>
            <Box sx={{width: '100%', display: 'flex', justifyContent: 'space-around', alignItems: 'center'}}>
                ...
                <Typography sx={{width: '50%', color: 'white', fontSize: '2rem', textAlign: 'justify'}}>
                    At NeighbourNet, we are dedicated to fostering a vibrant and supportive community through innovative solutions. Our goal is to create a platform that brings neighbours together, enabling them to help one another, share resources, and engage in local events.
                </Typography>
            </Box>
        </section>
        <section id='story' className='a'>
            <Box sx={{width: '100%', display: 'flex', justifyContent: 'space-around', alignItems: 'center'}}>
                <Typography sx={{width: '50%', color: 'white', fontSize: '2rem', textAlign: 'justify'}}>
                Founded in 2024, NeighbourNet began with a simple vision: to connect people within neighbourhoods and enhance community living. Inspired by the growing need for local support networks, we set out to build a comprehensive platform that could serve as a hub for assistance, resource sharing, and community engagement. From our initial concept to our current platform, we’ve grown thanks to the dedication of our team and the support of our users.
                </Typography>
                <Divider  orientation='vertical' sx={{backgroundColor: 'white', height: '40rem'}} />
                <Box sx={{display: 'flex', flexDirection: 'column'}}>
        ...
        <section id='things' className='a'>
            <Box sx={{width: '100%', display: 'flex', justifyContent: 'space-around', alignItems: 'center'}}>
                ...
                <Divider  orientation='vertical' sx={{backgroundColor: 'white', height: '40rem'}} />
                <div style={{width: '50%', color: 'white', fontSize: '1.5rem', textAlign: 'justify'}}>
                    <p>NeighbourNet specializes in creating connections within communities. Our platform offers features such as:</p>
                    <ul>
                        <li style={{paddingBottom: '1rem'}}>Help Requests: Users can post and respond to requests for help within their neighbourhood, creating a network of support.</li>
                        ...
                        <li style={{paddingBottom: '1rem'}}>Volunteer Coordination: Organize and find volunteers for neighbourhood activities, making it easier to get involved and contribute.</li>
                    </ul>
                </div>
            </Box>
        </section>
        <section id='visionvalue' className='a'>
            <Box sx={{height: '100%', width: '100%', display: 'flex', justifyContent: 'space-evenly'}}>
                <Box sx={{maxWidth: '40%', display: 'flex', alignItems: 'center', flexDirection: 'column', paddingTop: '2rem'}}>
                    ...
                    <div style={{color: 'white', fontSize: '1.5rem', textAlign: 'justify'}}>
                        <p>At NeighbourNet, we believe in:</p>
                        <ul>
                            <li>Community: Building strong, supportive networks where everyone feels connected.</li>
                            <li>Empathy: Understanding and responding to the needs of our neighbours with kindness and respect.</li>
